export default {
  ...
  'pages.searchTable.option' : 'Operation',
  'pages.searchTable.setting' : 'Setting',
  'pages.searchTable.download' : 'Download',
  'pages.searchTable.refresh' : 'Refresh',
  'pages.user-management.title' : 'User Management',
  'pages.user-management.updateForm.title' : 'Update User',
  'pages.user-group-management.createForm.title' : 'New User',
  'pages.exam-list.title' : 'Eaxm List',
  'pages.exam-subject.title' : 'Eaxm Subject List',
